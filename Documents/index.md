...
|Compensation|/move_stage              |geometry_msgs/msg/Pose     |The desired stage pose in the stage coordinate frame. In this implementation, the pose is defined only by x- and z- translations, while y-translation (insertion depth) and rotations are zero. This is an Action message (stage_control_interfaces/action/MoveStage).      |Stage           |
