...
|Compensation|/stage/cmd/pose              |geometry_msgs/msg/Pose     |The desired stage pose in the stage coordinate frame. In this implementation, the pose is defined only by x- and z- translations. y-translation (insertion depth) and rotations are zero.       |Stage           |
